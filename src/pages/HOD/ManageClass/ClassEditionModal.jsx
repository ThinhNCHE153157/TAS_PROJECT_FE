...
import TextFieldBase from '../../../component/TextFieldBase';

const ClassEditionModal = ({
  open,
  onClose,
  rowToEdit,
  onSave,
    ...
    >
      ...
      >
        ...
        <Grid container spacing={2} rowSpacing={2} justifyContent='flex-start'>
          <Grid item xs={7}>
            <TextFieldBase defaultValue={rowToEdit && rowToEdit.email ? rowToEdit.email : ''} label='Class Name' name='className' disable={true} />
          </Grid>
          <Grid item xs={5}>
            <TextFieldBase defaultValue={rowToEdit && rowToEdit.username ? rowToEdit.username : ''} label='Lecturer' name='lecturer' disable={true} />
          </Grid>
          <Grid item xs={6}>
            <TextFieldBase defaultValue={rowToEdit && rowToEdit.phone ? rowToEdit.phone : ''} label='Number Of Students' name='phone' onChange={handelOnChange} />
          </Grid>
          <Grid item xs={6}>
...
export default ClassEditionModal