...
const CountDownTimer = ({ initialTime, onTimeout }) => {
  ...
  useEffect(() => {
    ...
    const savedTime = localStorage.getItem('countdownTimerTime');
    const savedTimestamp = localStorage.getItem('countdownTimerTimestamp');
  ...
  useEffect(() => {
    ...
    localStorage.setItem('countdownTimerTime', time);
    localStorage.setItem('countdownTimerTimestamp', Date.now().toString());
